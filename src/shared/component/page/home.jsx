        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-md-4 mb-4">
                    ...
                    <p className={stls.classes.hoverMe}>Hover me.</p>
                    <p className={stls.classes.resizeMe}>Resize the window.</p>
                    <button className={stls.classes.specialButton}>Composition</button>
                </div>
                <div className="col-md-4 mb-4">
